...
class JsonDatabase {
    constructor() {
        ...
        this.tables = {
            ...
            employee_schedules: 'employee_schedules.json',
            schedule_sessions: 'schedule_sessions.json',
            schedule_force_open: 'schedule_force_open.json',
            store_schedule_settings: 'store_schedule_settings.json',
